  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        ...
        messages: [
          "0類には、情報や図書館、百科事典など、いろいろな分野に関係するものが集まっています。",
          "どれか1つの分野だけに入れるのが難しいものも多いんです。",
        ],
      },
      {
        visual: {
          ...
          items: [
            ...
            { code: "0類", title: "いろいろな分野に関係するもの" },
          ],
          takeaway: "0類＝全部に関係するもの・情報そのもの",
        },
        messages: [
          "0類は、「全部に関係するものの置き場」と考えてみましょう。",
          "情報そのものや、本を調べるためのものも集まります。",
        ],
      },
      {
        visual: {
    ...
    pages: [
      ...
      },
      {
        visual: {
          ...
          items: [
            ...
            { code: "9", title: "文学", description: "ことばで作品をつくる" },
          ],
        },
        messages: [
      ...
      },
      {
        visual: {
          ...
          takeaway: "何語で書かれたかより、何についての本か",
        },
        messages: [
          "英語で書かれているだけで、8類になるわけではありません。",
          "「何語で」より、「何について」の本かを見ましょう。",
        ],
      },
      {
        visual: {
